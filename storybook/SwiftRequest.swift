            ...
            if( err == nil) {
                if(response!.MIMEType == "text/html") {
                   ...
                   // var localError: NSError?
                    do {
                        if let json = try NSJSONSerialization.JSONObjectWithData(body! as NSData, options:NSJSONReadingOptions.MutableContainers) as? AnyObject! {
...
//                    var json: AnyObject! = NSJSONSerialization.JSONObjectWithData(body! as NSData, options: NSJSONReadingOptions.MutableContainers, error: NSError)
